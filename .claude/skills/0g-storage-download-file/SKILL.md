---
name: 0g-storage-download-file
description: Download and verify files from 0G Storage by root hash. Use for "download file", "retrieve from 0G", "get file from storage", "fetch from 0G Storage". Handles indexer.download() errors + exceptions.
---
