---
name: 0g-cross-compute-plus-storage
description: Combine 0G Compute with 0G Storage — e.g. generate image/transcribe audio then store result. Use for "AI with storage", "generate and store", "transcribe and store", cross-layer compute+storage flows.
---
