---
name: 0g-chain-deploy-contract
description: Deploy Solidity smart contracts to 0G Chain. Use for "deploy contract", "Solidity on 0G", "0G Chain deployment", or when configuring Hardhat/Foundry with evmVersion "cancun" for 0G Chain.
---
