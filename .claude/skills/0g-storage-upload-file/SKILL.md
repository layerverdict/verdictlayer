---
name: 0g-storage-upload-file
description: Upload files to 0G Storage via ZgFile + Indexer. Use for "upload file", "store on 0G", "ZgFile", "save to 0G Storage". Always closes ZgFile in finally block, uses indexer.upload(file, rpcUrl, signer) tuple return.
---
