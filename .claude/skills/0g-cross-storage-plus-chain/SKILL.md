---
name: 0g-cross-storage-plus-chain
description: Combine 0G Storage with 0G Chain — write storage root hashes on-chain. Use for "on-chain reference to file", "NFT metadata on 0G", "store hash on-chain", storage+chain bridging patterns.
---
