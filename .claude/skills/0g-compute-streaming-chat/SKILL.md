---
name: 0g-compute-streaming-chat
description: Run streaming LLM chat inference on 0G Compute (DeepSeek, Qwen, Gemma). Use for "chatbot on 0G", "LLM inference", "DeepSeek", "streaming chat", "AI chat on 0G". Always calls processResponse() after inference.
---
