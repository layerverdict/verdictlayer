---
name: 0g-chain-scaffold-project
description: Scaffold a new 0G project with correct SDK versions, .env template, and network config. Use for "new 0G project", "scaffold", "initialize 0G app", "setup 0G project".
---
