    ...
    <Card>
      <CardHeader>
        <div className="flex flex-wrap items-center gap-3">
          <CardTitle className="text-2xl">Check #{id.toString()}</CardTitle>
        ...
        <Field
          ...
          value={
            check.submittedAt > 0n
              ? formatTimestamp(Number(check.submittedAt) * 1000)
              : "—"
          }
        />
        <Field
...
function CertifiedBanner({ check }: { check: Check }) {
  return (
